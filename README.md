...
2. Clone the repository<br/>
	  * git clone https://github.com/karangm-dev/summary_evaluation.git<br/>

3. Cd into the directory<br/>
	  * cd summary_evaluation<br/>
...
8. Create a Kernel for Jupyter notebook<br/> 
	  * ipython kernel install --user --name=summary_evaluation<br/>  

9. Run the program<br/> 
	  * Open src/app.py with kernel summary_evaluation and run<br/> 
